...
```{r  out.width = "60%", fig.align = "center"}
include_graphics("/cloud/project/results/07_size_bm_boxplot.png") 
```
...
```{r  out.width = "60%", fig.align = "center"}
include_graphics("/cloud/project/results/07_hemoglobin_bm_boxplot.png") 
```
...
include_graphics("/cloud/project/results/07_status_bm_plot.png") 
```
...
```{r  out.width = "60%", fig.align = "center"}
include_graphics("/cloud/project/results/07_activity_bm_plot.png") 
```
...
include_graphics("/cloud/project/results/07_estrogen_plots.png") 
```
