...
- <font size="4">The prostate cancer was the second highest cause of death.</font>
- <font size="4">The stages of the prostate cancer did not make significant difference in the tumor size.</font>
...
## PCA analysis shows if the data groups based on all the variables
- <font size="4">A PCA analysis is carried out to search for groupings and patterns of the data based on all variables</font>
- <font size="4">The plot shows the variance explained by the different principal components
=======
=======
## ANN slide...
...
=======
## Conclusions
- Prostatic acid (PA) phosphatase levels are higher in patients with metastases and have died from prostate cancer
